...
public class CreateQuery extends Query<CreateQuery, CreateResponse>
{
    ...
    public CreateQuery(String endpoint) { super(Type.GET, endpoint, ADDR, CreateResponse.class); }
    public CreateQuery name(String value) { args.put(ARG_NAME, requireNonNull(value, "value can't be null")); return this; }
